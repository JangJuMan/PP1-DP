...
public class MainTest {
	...
	public void testMain() {
		...
		String[] args = {"/Users/juman/PP1-DP","data/PP1-DP.arff"}; // for mac users
	...
	public void testForTasks2() {
		...
		String[] args = {"/Users/juman/techjobs-mvc","data/techjobs-mvc.arff"};
		assertEquals(args.length, 2);
		Main.main(args);
		
		String[] args2 = {"/Users/juman/cheese-mvc-persistent","data/cheese-mvc-persistent.arff"};
		assertEquals(args2.length, 2);
		Main.main(args2);
		
		String[] args3 = {"/Users/juman/spring-boot","data/spring-boot.arff"};
		assertEquals(args3.length , 2);
		Main.main(args3);
